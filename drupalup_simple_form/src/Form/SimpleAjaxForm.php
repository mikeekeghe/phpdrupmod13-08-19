...
class SimpleAjaxForm extends FormBase {
    ...
    public function setMessage(array &$form, FormStateInterface $form_state) {
        ...
        $response->addCommand(
            new HtmlCommand(
                '.result_message',
                '<div class="my_top_message">' . $this->t('The result is @result', ['@result' => "https://www.autorescue.ng/dealer/index.php?email=info@mymech.ng&password=mech1000&vin=".($form_state->getValue('number_1') )])
